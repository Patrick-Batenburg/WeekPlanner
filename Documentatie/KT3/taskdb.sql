...
DROP DATABASE IF EXISTS `gezinsbe`;
CREATE DATABASE IF NOT EXISTS `gezinsbe` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `gezinsbe`;
...
INSERT INTO `users`(`Username`, `Password`, `Role`) VALUES ("J van Aert", "24be3ba7496f6070bb5104ef9038394be4e0e064", "Admin");
